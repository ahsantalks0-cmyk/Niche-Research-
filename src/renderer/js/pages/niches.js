...
/**
 * NRD · pages/niches.js — Niches library (Phase 0 empty state, Atelier).
 */
(function () {
    ...
    render() {
      ...
      el.innerHTML = `
        <div class="page-head">
          <div>
            <h2>Niche library</h2>
            <div class="ph-sub">Every validated niche with scores, competition and monetization data.</div>
          </div>
        </div>

        <div class="toolbar">
          <div class="input ph-input">
            ${NRDIcons.get('search')} <span style="font-size:12.5px">Search niches…</span>
          </div>

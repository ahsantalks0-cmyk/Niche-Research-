...
/**
 * NRD · pages/research.js — New Research (Noir Atelier).
 */
(function () {
      ...
      el.innerHTML = `
        <div class="page-head">
          <div>
            ...
            <div class="ph-sub">Configure a research run — the 35-agent swarm executes it in Phase 1.</div>
          </div>
        </div>
        ...
        <div class="nr-grid">
          ...
          <div class="nr-start">
            <div class="panel panel-pad panel-hero">
              ...
              <button class="btn btn-cu btn-lg btn-block tt" id="btn-start" data-tip="Agents coming in Phase 1+"
            ...
            <div class="panel panel-pad" style="margin-top:14px">
              <div class="kv-row">
                ...
                <span class="kv-v text-cu">Armed</span>
              </div>
              <div class="kv-row">
